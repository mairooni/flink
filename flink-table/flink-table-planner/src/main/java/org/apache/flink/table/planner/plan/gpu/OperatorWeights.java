 ...
 * instruction than to eight, but what matters for the decision is that an expression full of
 * {@code SQRT} carries more device-eligible work than one full of adds, and that the ratio does not
 * invert between devices.
 *
...
public final class OperatorWeights {
    ...
    private static final Map<SqlKind, Integer> BY_KIND = Map.ofEntries(
            // Arithmetic. The unit.
            ...
            // A widening numeric cast is free on device; narrowing and non-numeric casts are
